            ...
            <div class="head-right-menu pull-right col-xs-3">
                ...
                <div class="log-main">
                    <ul>
                        ...
                        <?php else: ?>
                            <li class="log-sign-in"><a href="#" data-toggle="modal" data-target="#cbts-login-modal"><?= __('Log In') ?></a></li>
                            <li class="log-sign-up"><a href="#" data-toggle="modal" data-target="#cbts-signup-modal"><?= __('Sign In') ?></a></li>
                        <?php endif; ?>
                    </ul>
