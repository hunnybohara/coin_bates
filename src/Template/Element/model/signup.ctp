    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="model-midd-content">
                ...
                <a href="<?= $this->Html->getFacebookLoginUrl(); ?>" class="facebook-login">Sign up with Facebook</a>
                <a href="#" id="gplussignin" class="gplus-login">Sign up with Google+</a>
                <div class="or-space">
                    <span>or</span>
                </div>
                ...
                <div class="login-form-main">
                    ...
                    ?>
                        ...
                        <div class="dont-account">Already a Coinbates member? <a href="#" class="sign-in-btn">Log in</a></div>
                    </form>
                </div>
