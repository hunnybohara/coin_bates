...
class FilesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 512, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'mime_type' => ['type' => 'string', 'length' => 256, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'owner_id' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
...
'engine' => 'InnoDB', 'collation' => 'latin1_swedish_ci'
    ...
    public $records = [
        [
            ...
            'user_id' => '',
            'created' => '2015-06-28 11:00:45',
            'modified' => '2015-06-28 11:00:45'
        ],
    ];
}
